 ...
 * 
 * This file contains the unified type definitions for Firestore collections
 * using a subcollection-based architecture for better query performance
...
export type HistoryEntryType = 'status_change' | 'assignment' | 'note';
